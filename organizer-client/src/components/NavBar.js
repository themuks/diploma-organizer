            ...
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="flex items-center md:order-3">
                    <button type="button"
                        ...
                        <FaUser className="w-8 h-8 rounded-full text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/>
                    </button>
                    <div
                ...
                <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-2"
                    ...
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        <li>
                            <NavBarNavLink to="/app" text={({isActive}) => (
