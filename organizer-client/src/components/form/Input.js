...
const Input = ({ label, name, type, defaultValue, register, required, isError, className, placeholder }) => {
    return (<div className={className}>
        ...
        <input
            ...
            type={type} defaultValue={defaultValue} placeholder={placeholder} {...register(name, { required })} />
    </div>);
};
